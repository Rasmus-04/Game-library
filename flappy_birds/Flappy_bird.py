...
bg_img = pygame.image.load(os.path.join("Assetes", "bg.png"))
bird_img = pygame.image.load(os.path.join("Assetes", "bird.png"))
bird_img_up = pygame.image.load(os.path.join("Assetes", "bird_up.png"))
bird_img_down = pygame.image.load(os.path.join("Assetes", "bird_down.png"))
pipe_img = pygame.image.load(os.path.join("Assetes", "pipe.png"))
cloud_img = pygame.image.load(os.path.join("Assetes", "cloud.png"))
